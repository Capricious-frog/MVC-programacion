...
public class ClaseVista extends javax.swing.JFrame {
	...
	String[] arrayDivisas = { "Euro - €", "Dolar - $", "Yen - ¥", "Libras - £", "Pesos - $" };
	JComboBox divisas = null;
	JComboBox divisas2 = null;
	JFrame frame = null;
	...
	public  ClaseVista(){
		...
		((JPanel)getContentPane()).setOpaque(false); ImageIcon uno=new ImageIcon(this.getClass().getResource("/imagenes/fondo.gif")); JLabel fondo= new JLabel(); fondo.setIcon(uno); getLayeredPane().add(fondo,JLayeredPane.FRAME_CONTENT_LAYER); fondo.setBounds(0,0,uno.getIconWidth(),uno.getIconHeight());
	...
	public ClaseVista(boolean z) {
		...
		divisas = new JComboBox(arrayDivisas);
		...
		divisas2 = new JComboBox(arrayDivisas);
		...
		((JPanel)getContentPane()).setOpaque(false); ImageIcon uno=new ImageIcon(this.getClass().getResource("/imagenes/fondo_dinero.jpg")); JLabel fondo= new JLabel(); fondo.setIcon(uno); getLayeredPane().add(fondo,JLayeredPane.FRAME_CONTENT_LAYER); fondo.setBounds(0,0,uno.getIconWidth(),uno.getIconHeight());
	...
	public  ClaseVista(int i){
		...
		((JPanel)getContentPane()).setOpaque(false); ImageIcon uno=new ImageIcon(this.getClass().getResource("/imagenes/fondo2.png")); JLabel fondo= new JLabel(); fondo.setIcon(uno); getLayeredPane().add(fondo,JLayeredPane.FRAME_CONTENT_LAYER); fondo.setBounds(0,0,uno.getIconWidth(),uno.getIconHeight());
